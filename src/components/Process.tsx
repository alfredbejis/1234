    ...
    <section id="proceso" ref={containerRef} className="py-20 md:py-32 px-4 sm:px-6 relative bg-dark-800/20">
      <div className="w-full max-w-[1200px] mx-auto">
        ...
        <div className="relative">
          {/* Base gray line */}
          <div className="absolute left-[20px] md:left-1/2 top-0 bottom-0 w-0.5 bg-gray-600 transform md:-translate-x-1/2 z-0" />
          
          {/* Neon filling line with enhanced glow */}
          <motion.div 
            style={{ height: lineHeight }}
            className="absolute left-[20px] md:left-1/2 top-0 w-1 bg-gradient-to-b from-neon-green via-neon-cyan to-neon-purple shadow-[0_0_15px_rgba(204,255,0,0.8)] transform md:-translate-x-1/2 origin-top z-10"
          />

          <div className="space-y-16 md:space-y-24 pb-12 md:pb-24 relative z-20">
              ...
              >
                ...
                >
                  <div className={`p-6 md:p-8 rounded-2xl border transition-all duration-500 ${
                    isReached 
                      ? 'border-neon-green/50 bg-white/5 shadow-[0_0_20px_rgba(204,255,0,0.3)]' 
                      : 'border-white/10 opacity-70'
                  } ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <h3 className={`text-xl md:text-2xl font-display font-bold mb-2 transition-all duration-500 ${
                      isReached 
                        ? 'text-white' 
                        : 'text-gray-500'
                    }`}>
                    ...
                    <p className={`text-gray-400 leading-relaxed text-sm md:text-base transition-all duration-500 ${
                ...
                <div className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 flex items-center justify-center z-30">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-500 border-2 ${
                    isReached 
                      ? 'bg-dark-900 border-neon-green shadow-[0_0_20px_rgba(204,255,0,0.6)] scale-110' 
                      : 'bg-dark-900 border-gray-600 opacity-50 scale-90'
                  }`}>
